...
<?php
  ...
  echo "<form method=\"post\" action=\"braindrainedit.php\" id=\"textbox\">";
  ...
  echo "<div class=\"texta\">";
    echo "<textarea name=\"CONTENT\" form=\"textbox\" maxlength=\"1000\" autofocus style=\"font-size:120%; width: 80%; min-height: 200px;\">".$row["content"]."</textarea></div>";
